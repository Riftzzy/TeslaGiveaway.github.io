...
(() => {
    ...
    const R = 5e7
    localStorage.setItem("procent", 423e5), A.innerHTML = localStorage.getItem("procent").toLocaleString("en-EN");
    ...
    !function e() {
        setTimeout((function () {
            let t = (o = 5000, r = 10000, Math.floor(Math.random() * (r - o + 1)) + o);
            var o, r;
            let n = M - t;
            if (n < M && n > 0) {
                g(A, M, M - t, 20);
            ...
            } else M = 42353647, L.setAttribute("stroke-dasharray", "60,100"), localStorage.setItem("procent", 42353647);
            I++, I < 50 && e()
        }), 5e3)
    }();
